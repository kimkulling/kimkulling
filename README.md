...
## My Projects:
- [My 2D/3D Render Engine](https://github.com/kimkulling/Segfault) - A vulkan-based engine for my own projects
- [A cppcore lib for stl-free projects](https://github.com/kimkulling/cppcore) - The collection of cpp-tools I am using
- [A tiny UI lib](https://github.com/kimkulling/tiny_ui) - UI lib for my private projects
- [An OpenDDL Loader Lib](https://github.com/kimkulling/openddl-parser) - Parser for openddl-assets, written for the Assimp-lib
